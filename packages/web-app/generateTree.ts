// modified from https://github.com/Anish-Agnihotri/merkle-airdrop-starter/blob/master/generator/src/generator.ts
...
export default class Generator {
   ...
   */
  generateLeaf(address: string, value: string) {
    return Buffer.from(
